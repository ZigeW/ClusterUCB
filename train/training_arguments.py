...
class TrainingArguments(TA):
    ...
    dynamic_train: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to use dynamic training"
            )
        }
    )
    warmup_train: bool = field(
        default=False,
        metadata={
            "help": (
                "Whether to stop after warmup steps"
            )
        }
    )
    dynamic_task: str = field(
        default=None,
        metadata={
            "help": (
                "The targeted dynamic training task. "
            )
        },
    )
