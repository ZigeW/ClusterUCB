...
class DataArguments:
    ...
    examples: int = field(
        default=15000, metadata={"help": ("Number of examples for each dataset")}
    )
    val_data_dir: Optional[str] = field(
        default=None, metadata={"help": ("The data dir for validation data")}
    )
    use_chat_format: Optional[bool] = field(
        default=False, metadata={"help": ("Use char format for validation data or not")}
    )
    chat_format: Optional[str] = field(
        default=None, metadata={"help": ("The chat format used for validation data")}
    )
